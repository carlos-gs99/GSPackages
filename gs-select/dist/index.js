...
var GSSelectComponent = (props, ref) => {
  ...
  const asyncDebounceTimerRef = useRef(null);
  ...
  const filterOptions = useCallback((opts, query) => {
  ...
  const renderClearButton = () => {
    ...
    return /* @__PURE__ */ jsx(
      ButtonBase,
      {
        ...
        tabIndex: -1,
        "data-gs-el": "clear",
        children: /* @__PURE__ */ jsx(GSIcon, { name: "close", size: 1 })
      }
    );
  };
  const renderValidationIcon = () => {
    ...
    return /* @__PURE__ */ jsx(
      "span",
      {
        className: clsx(styles_default.selectValidationIcon, {
  ...
  const renderLoadingSpinner = () => {
    ...
    return /* @__PURE__ */ jsxs("span", { className: styles_default.selectLoadingSpinner, "data-gs-el": "loading", children: [
      /* @__PURE__ */ jsx(
        GSLoading,
        {
          mode: "section",
          ...
          className: clsx(styles_default.inlineLoading, {
            [styles_default.inlineLoadingNoText]: !showText
          }),
          style: { padding: 0, minHeight: 0, width: "auto" }
        }
      ),
      !showText && /* @__PURE__ */ jsx("span", { className: "gs-sr-only", children: effectiveLoadingMessage })
    ] });
  };
  const renderTrigger = () => {
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              className: clsx(styles_default.selectInput, {
                [styles_default.selectPlaceholder]: selectedOptions.length === 0,
                [styles_default["selectInput--multiple"]]: isMultipleMode
              }),
              "data-gs-el": "value",
              children: isMultipleMode ? selectedOptions.length > 0 ? /* @__PURE__ */ jsx("div", { className: styles_default.selectChips, "data-gs-el": "chips", children: selectedOptions.map((opt) => /* @__PURE__ */ jsxs(
                "span",
                {
                  className: styles_default.selectChip,
                  "data-gs-el": "chip",
                  children: [
                    /* @__PURE__ */ jsx("span", { className: styles_default.selectChipLabel, children: opt.label }),
                    /* @__PURE__ */ jsx(
                      ButtonBase,
                      {
                        type: "button",
          ...
          endDecorator && /* @__PURE__ */ jsx("span", { className: styles_default.selectEndDecorator, "data-gs-el": "endDecorator", children: endDecorator }),
          !clearButtonOutside && renderClearButton(),
          !validationIconOutside && renderValidationIcon(),
          loading && loadingPosition === "inside" ? renderLoadingSpinner() : /* @__PURE__ */ jsx("span", { className: styles_default.selectIcon, "data-gs-el": "icon", children: /* @__PURE__ */ jsx(ChevronUpDownIcon, {}) })
        ]
      }
    );
  };
  const renderSingleOption = (option, index, groupIndex) => {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        className: clsx(styles_default.selectOption, {
        ...
        children: renderOption ? renderOption(option, isSelected) : /* @__PURE__ */ jsxs(Fragment, { children: [
          isMultipleMode && /* @__PURE__ */ jsx(
            "span",
            {
              className: clsx(styles_default.selectOptionCheckbox, {
          ...
          option.label,
          !isMultipleMode && isSelected && /* @__PURE__ */ jsx("span", { className: styles_default.selectOptionCheck, "data-gs-el": "check", children: /* @__PURE__ */ jsx(CheckIcon, {}) })
        ] })
      },
      String(option.value)
    );
    ...
    if (isLoadingAsync) {
      return /* @__PURE__ */ jsx(
        "div",
        {
          ...
          "data-gs-el": "dropdown",
          style: dropdownStyle,
          children: /* @__PURE__ */ jsx("div", { className: styles_default.selectLoadingState, "data-gs-el": "loading", children: /* @__PURE__ */ jsx(
            GSLoading,
            {
              mode: "section",
              variant: "transparent",
    ...
    if (asyncError) {
      return /* @__PURE__ */ jsx(
        "div",
        {
          ...
          "data-gs-el": "dropdown",
          style: dropdownStyle,
          children: /* @__PURE__ */ jsxs("div", { className: styles_default.selectErrorState, "data-gs-el": "async-error", children: [
            /* @__PURE__ */ jsx(GSIcon, { name: "alert-circle", size: 1 }),
            /* @__PURE__ */ jsx("span", { children: asyncError })
          ] })
        }
      );
    }
    if (flatOptions.length === 0) {
      return /* @__PURE__ */ jsx(
        "div",
        {
          ...
          "data-gs-el": "dropdown",
          style: dropdownStyle,
          children: /* @__PURE__ */ jsx("div", { className: styles_default.selectEmptyState, "data-gs-el": "empty", children: effectiveEmptyMessage })
        }
      );
    }
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          filteredOptionGroups ? filteredOptionGroups.map((group, groupIndex) => /* @__PURE__ */ jsxs(
            "div",
            {
  ...
  if (label || error || helperText) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        "data-gs-debug": debug ? "true" : void 0,
        children: [
          label && /* @__PURE__ */ jsxs("div", { className: styles_default.selectLabelContainer, "data-gs-el": "labelContainer", children: [
            /* @__PURE__ */ jsx(
              "label",
              {
                htmlFor: baseId,
                id: labelId,
                className: clsx(styles_default.selectLabel, labelClassName, {
          ...
          /* @__PURE__ */ jsxs("div", { className: styles_default.selectWrapper, "data-gs-el": "wrapper", children: [
            /* @__PURE__ */ jsxs("div", { className: styles_default.selectTriggerWrapper, "data-gs-el": "triggerWrapper", children: [
              renderTrigger(),
              clearButtonOutside && renderClearButton(),
              validationIconOutside && renderValidationIcon(),
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      "data-gs-loading": loading ? "true" : void 0,
      "data-gs-debug": debug ? "true" : void 0,
      children: /* @__PURE__ */ jsxs("div", { className: styles_default.selectWrapper, "data-gs-el": "wrapper", children: [
        /* @__PURE__ */ jsxs("div", { className: styles_default.selectTriggerWrapper, "data-gs-el": "triggerWrapper", children: [
          renderTrigger(),
          clearButtonOutside && renderClearButton(),
          validationIconOutside && renderValidationIcon(),
...
var GSSelect = forwardRef(GSSelectComponent);
...
export {
  GSSelect_default as GSSelect,
  GS_SELECT_NAMESPACE,
  GSSelect_default as default,
